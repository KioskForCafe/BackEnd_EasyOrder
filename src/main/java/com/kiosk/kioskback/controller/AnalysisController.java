...
public class AnalysisController {
    ...
    @ApiOperation(value = "매장 상품별 매출 정보 조회", notes = "Request Header Athorization에 Bearer JWT를 포함하고 Path Variable에 매장 번호와매출인식 시작일, 매출인식 마감일을 포함하여 요청하면, 성공 시 상품별, 카테고리별 판매 건수와 금액 데이터를 반환, 실패 시 실패 메세지를 반환")
    @GetMapping(GET_BUSINESS)
