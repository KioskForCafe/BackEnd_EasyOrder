...
public class AlarmController {
    ...
    @Operation(summary = "알람 리스트 보기", description = "Request Header Authorization에 Bearer JWT를 포함하고 Path Variable에 storeId를 포함하여 요청을 하면 성공 시 알람 전체 데이터를 반환, 실패 시 실패 메세지 반환")
    ...
    @Operation(summary="등록 알람", description="Request Header Athorization에 Bearer JWT를 포함하고 Request Body에 등록 정보를 포함하여 요청하면 성공시 알람 메세지를 반환, 실패시 실패 메세지를 반환")
