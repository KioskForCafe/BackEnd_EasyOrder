...
public class PointController {
    ...
    public ResponseDto<GetPointResponseDto> getPoint(@RequestBody GetPointDto requestBody) {
        ResponseDto<GetPointResponseDto> response = pointService.getPoint(requestBody);
        return response;
    }
